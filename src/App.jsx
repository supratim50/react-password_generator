...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    let pass = "";
    let str = "ABCDEFGHIJKLMNOPQRSTUVWXYZbacdefghijklmnopqrstuvwxyz";
  ...
  return (
    <>
      <div className="w-full h-screen bg-gray-950 py-8">
        <div className="w-full max-w-md mx-auto shadow-md rounded-lg p-4 text-orange-500 bg-gray-800">
          ...
          <div className="flex text-sm gap-x-2">
            <div className="flex items-center gap-x-1">
              <input type="range" min={8} max={36} value={length} className="cursor-pointer" onChange={(e) => {setLength(e.target.value)}} />
